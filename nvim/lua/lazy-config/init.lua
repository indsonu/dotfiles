-- Place where we add all the plugins
...
vim.api.nvim_set_hl(0, "Function", { fg = "#0000FF" }) -- Blue color for functions/methods
vim.opt.guifont = "JetBrainsMono Nerd Font:h14" -- Adjust the font name and size as needed
